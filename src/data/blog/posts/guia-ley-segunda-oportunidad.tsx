...
export const guiaLeySegundaOportunidad: BlogPost = {
  ...
  seoTitle: "⚖️ Ley de Segunda Oportunidad: guía por abogados 2026",
  metaDescription:
    "Guía 2026 de la Ley de Segunda Oportunidad explicada por abogados: casos reales, sentencias, letra pequeña y errores que la bloquean.",
  faq: [
    {
            ...
            groups={[
              {
                ...
                items: [
                  ...
                  { title: "Buena fe del deudor en la Ley de Segunda Oportunidad: cómo se interpreta", to: "/blog/buena-fe-del-deudor-en-la-ley-de-segunda-oportunidad-como-se-interpreta" },
                  { title: "Insolvencia actual vs. inminente en la Ley de Segunda Oportunidad", to: "/blog/insolvencia-actual-vs-inminente-en-la-ley-de-segunda-oportunidad" },
                  { title: "Antecedentes penales y Ley de Segunda Oportunidad: qué delitos la impiden", to: "/blog/antecedentes-penales-y-ley-de-segunda-oportunidad-que-delitos-la-impiden" },
                  { title: "¿Puedo acogerme dos veces a la Ley de Segunda Oportunidad?", to: "/blog/puedo-acogerme-dos-veces-a-la-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  { title: "Cancelar microcréditos con la Ley de Segunda Oportunidad", to: "/blog/cancelar-microcreditos-con-la-ley-de-segunda-oportunidad" },
                  { title: "Tarjetas revolving y Ley de Segunda Oportunidad: cómo se incluyen", to: "/blog/tarjetas-revolving-y-ley-de-segunda-oportunidad-como-se-incluyen" },
                  { title: "Cancelar avales personales con la Ley de Segunda Oportunidad", to: "/blog/cancelar-avales-personales-con-la-ley-de-segunda-oportunidad" },
                  { title: "Deudas con proveedores en la Ley de Segunda Oportunidad", to: "/blog/deudas-con-proveedores-en-la-ley-de-segunda-oportunidad" },
                  { title: "Préstamos entre particulares y Ley de Segunda Oportunidad", to: "/blog/prestamos-entre-particulares-y-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  { title: "Ley de Segunda Oportunidad paso a paso: del análisis previo a la EPI", to: "/blog/ley-de-segunda-oportunidad-paso-a-paso-del-analisis-previo-a-la-epi" },
                  { title: "Documentación para la Ley de Segunda Oportunidad: checklist completo", to: "/blog/documentacion-para-la-ley-de-segunda-oportunidad-checklist-completo" },
                  { title: "Juzgado competente en la Ley de Segunda Oportunidad: cómo se determina", to: "/blog/juzgado-competente-en-la-ley-de-segunda-oportunidad-como-se-determina" },
                  { title: "Administrador concursal en la Ley de Segunda Oportunidad: cuándo aparece", to: "/blog/administrador-concursal-en-la-ley-de-segunda-oportunidad-cuando-aparece" },
                  { title: "Oposición de acreedores en la Ley de Segunda Oportunidad: cómo se resuelve", to: "/blog/oposicion-de-acreedores-en-la-ley-de-segunda-oportunidad-como-se-resuelve" },
                ],
              },
              {
                ...
                items: [
                  ...
                  { title: "Cuenta bancaria embargada: cómo la libera la Ley de Segunda Oportunidad", to: "/blog/cuenta-bancaria-embargada-como-la-libera-la-ley-de-segunda-oportunidad" },
                  { title: "Embargo de nómina y Ley de Segunda Oportunidad: cuándo vuelve íntegra", to: "/blog/embargo-de-nomina-y-ley-de-segunda-oportunidad-cuando-vuelve-integra" },
                  { title: "Embargo del vehículo y Ley de Segunda Oportunidad: cuándo se evita la subasta", to: "/blog/embargo-del-vehiculo-y-ley-de-segunda-oportunidad-cuando-se-evita-la-subasta" },
                  { title: "Varios embargos a la vez en la Ley de Segunda Oportunidad", to: "/blog/varios-embargos-a-la-vez-en-la-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  { title: "Vivienda habitual en la Ley de Segunda Oportunidad: cuándo se conserva", to: "/blog/vivienda-habitual-en-la-ley-de-segunda-oportunidad-cuando-se-conserva" },
                  { title: "Conservar la vivienda con la Ley de Segunda Oportunidad y plan de pagos", to: "/blog/conservar-la-vivienda-con-la-ley-de-segunda-oportunidad-y-plan-de-pagos" },
                  { title: "Ejecución hipotecaria y Ley de Segunda Oportunidad: ¿se puede parar?", to: "/blog/ejecucion-hipotecaria-y-ley-de-segunda-oportunidad-se-puede-parar" },
                  { title: "Dación en pago vs. Ley de Segunda Oportunidad: cuándo conviene cada una", to: "/blog/dacion-en-pago-vs-ley-de-segunda-oportunidad-cuando-conviene-cada-una" },
                  { title: "Segunda vivienda y herencias en la Ley de Segunda Oportunidad", to: "/blog/segunda-vivienda-y-herencias-en-la-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  ...
                  { title: "Autónomos en activo y Ley de Segunda Oportunidad: compatibilidad", to: "/blog/autonomos-en-activo-y-ley-de-segunda-oportunidad-compatibilidad" },
                  { title: "Avales personales de administrador en la Ley de Segunda Oportunidad", to: "/blog/avales-personales-de-administrador-en-la-ley-de-segunda-oportunidad" },
                  { title: "Cerrar una SL y acogerse después a la Ley de Segunda Oportunidad", to: "/blog/cerrar-una-sl-y-acogerse-despues-a-la-ley-de-segunda-oportunidad" },
                  { title: "Deuda de IVA acumulada y Ley de Segunda Oportunidad: vías reales", to: "/blog/deuda-de-iva-acumulada-y-ley-de-segunda-oportunidad-vias-reales" },
                ],
              },
              {
                ...
                items: [
                  { title: "Cancelar deuda con Hacienda con la Ley de Segunda Oportunidad: límites", to: "/blog/cancelar-deuda-con-hacienda-con-la-ley-de-segunda-oportunidad-limites" },
                  { title: "Cancelar deuda con la Seguridad Social en la Ley de Segunda Oportunidad", to: "/blog/cancelar-deuda-con-la-seguridad-social-en-la-ley-de-segunda-oportunidad" },
                  { title: "Apremios y recargos en la Ley de Segunda Oportunidad: cómo se calculan", to: "/blog/apremios-y-recargos-en-la-ley-de-segunda-oportunidad-como-se-calculan" },
                  { title: "Embargo de la AEAT y Ley de Segunda Oportunidad: cómo se levanta", to: "/blog/embargo-de-la-aeat-y-ley-de-segunda-oportunidad-como-se-levanta" },
                  { title: "Aplazamientos con Hacienda fracasados: paso a la Ley de Segunda Oportunidad", to: "/blog/aplazamientos-con-hacienda-fracasados-paso-a-la-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  ...
                  { title: "ASNEF, Badexcug, RAI y CIRBE: cuál afecta más a la Ley de Segunda Oportunidad", to: "/blog/asnef-badexcug-rai-y-cirbe-cual-afecta-mas-a-la-ley-de-segunda-oportunidad" },
                  { title: "Solicitar la baja en ASNEF tras la Ley de Segunda Oportunidad", to: "/blog/solicitar-la-baja-en-asnef-tras-la-ley-de-segunda-oportunidad" },
                  { title: "Alquilar piso estando en ASNEF tras la Ley de Segunda Oportunidad", to: "/blog/alquilar-piso-estando-en-asnef-tras-la-ley-de-segunda-oportunidad" },
                  { title: "Cuánto tarda en limpiarse el historial tras la Ley de Segunda Oportunidad", to: "/blog/cuanto-tarda-en-limpiarse-el-historial-tras-la-ley-de-segunda-oportunidad" },
                ],
              },
              {
                ...
                items: [
                  ...
                  { title: "Reconstruir el historial crediticio tras la Ley de Segunda Oportunidad", to: "/blog/reconstruir-el-historial-crediticio-tras-la-ley-de-segunda-oportunidad" },
                  { title: "Abrir una cuenta bancaria tras la Ley de Segunda Oportunidad", to: "/blog/abrir-una-cuenta-bancaria-tras-la-ley-de-segunda-oportunidad" },
                  { title: "Primer crédito tras la Ley de Segunda Oportunidad: cuándo y cómo", to: "/blog/primer-credito-tras-la-ley-de-segunda-oportunidad-cuando-y-como" },
                  { title: "Plan de ahorro tras la Ley de Segunda Oportunidad: por dónde empezar", to: "/blog/plan-de-ahorro-tras-la-ley-de-segunda-oportunidad-por-donde-empezar" },
                ],
              },
              {
                ...
                items: [
                  ...
                  { title: "Reunificación de deudas vs. Ley de Segunda Oportunidad", to: "/blog/reunificacion-de-deudas-vs-ley-de-segunda-oportunidad" },
                  { title: "Concurso de acreedores vs. Ley de Segunda Oportunidad: diferencias", to: "/blog/concurso-de-acreedores-vs-ley-de-segunda-oportunidad-diferencias" },
                  { title: "Ley de Segunda Oportunidad en pareja: expediente conjunto o separado", to: "/blog/ley-de-segunda-oportunidad-en-pareja-expediente-conjunto-o-separado" },
                  { title: "Herencia con deudas y Ley de Segunda Oportunidad: qué hacer", to: "/blog/herencia-con-deudas-y-ley-de-segunda-oportunidad-que-hacer" },
                ],
              },
            ]}
          />
