...
export const entities: Entity[] = [
  ...
  { slug: "cabot", name: "Cabot Financial Spain", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "pra-group", name: "PRA Group", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "b2-impact", name: "B2 Impact", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "zolva", name: "Zolva", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "investcapital", name: "InvestCapital Ltd", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "promontoria-ares", name: "Promontoria Ares DAC", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "recoverit", name: "Recoverit", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "furio-capital", name: "Furio Capital", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "cobratis", name: "Cobratis", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "cobrador-del-frac", name: "El Cobrador del Frac", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "bulnes-capital", name: "Bulnes Capital", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "grove-capital", name: "Grove Capital Management", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "finsolutia", name: "Finsolutia", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "hispania-asset-management", name: "Hispania Asset Management", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "savia-asset-management", name: "Savia Asset Management", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "bcmglobal", name: "BCMGlobal", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "copernicus-servicing", name: "Copernicus Servicing", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "diglo", name: "Diglo", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "servihabitat", name: "Servihabitat", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "aliseda", name: "Aliseda", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "anticipa", name: "Anticipa Real Estate", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "ahora-asset-management", name: "Ahora Asset Management", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "lexer", name: "Lexer", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "libroley", name: "Libroley", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "acuerdo-ejaso", name: "Acuerdo Servicios Jurídicos", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "zelsior", name: "Zelsior", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "ka-recovering", name: "KA Recovering Services", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "gap-recovery", name: "GAP Recovery", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "isgf", name: "ISGF", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "geri-espana", name: "GERI España", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "agesco", name: "AGESCO", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "esco-expansion", name: "ESCO Expansión", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "team4-collection", name: "TEAM4 Collection & Consulting", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "formax-recoveries", name: "Formax Recoveries", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "hg-cobros", name: "HG Cobros", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "dominus-recobros", name: "Dominus Recobros", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "collecta", name: "Collecta", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "cir", name: "CIR", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "ari", name: "Acción de Recupero Ibérica", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "emergia", name: "Emergia Smart Collections", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "tuscany-adquisiciones", name: "Tuscany Adquisiciones", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "gestimed", name: "Gestimed", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "ges40", name: "GES40", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "bjs-legal", name: "BJS Legal Services", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "atradius-collections", name: "Atradius Collections", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  { slug: "coface-collections", name: "Coface Collections", kind: "recobro", cluster: "empresas-de-recobro", solutionPath: "/cancelar-deudas" },
  // Microcréditos
