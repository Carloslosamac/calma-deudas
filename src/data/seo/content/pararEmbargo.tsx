...
export const pararEmbargo: MoneyContent = {
  ...
  testimonials: [
    ...
    { name: "Antonio L.", amount: "Vivienda a salvo", location: "Sevilla", text: "Estaba en ejecución hipotecaria. Actuaron rápido y pudimos negociar.", photo: p4 },
    { name: "Marta S.", amount: "Sin embargos", location: "Bilbao", text: "Acumulaba varios embargos. Con la Segunda Oportunidad empecé de cero.", photo: p3 },
    { name: "Francisco D.", amount: "Cuenta liberada", location: "Málaga", text: "Me bloquearon la cuenta de un día para otro. Pararon el embargo en 48 horas.", photo: p6 },
    { name: "Rosa M.", amount: "Nómina protegida", location: "Zaragoza", text: "Me dejaban sin sueldo cada mes. Recuperé el mínimo inembargable enseguida.", photo: p5 },
  ],
