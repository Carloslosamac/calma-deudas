...
const InlineCTA = ({
  ...
  <aside className="my-2 overflow-hidden rounded-3xl border border-accent/40 bg-gradient-to-br from-accent-soft/60 via-surface-elevated to-surface-elevated p-7 shadow-soft md:p-9">
