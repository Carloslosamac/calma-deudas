...
async function buildPrompt(title: string, category: string, slug: string): Promise<string> {
  ...
  return `Fotografía documental casual de OBJETOS O LUGARES VACÍOS, tomada con un teléfono móvil moderno (iPhone/Samsung), estilo snapshot cotidiano español. NO profesional, NO editorial, NO publicidad, NO stock.
